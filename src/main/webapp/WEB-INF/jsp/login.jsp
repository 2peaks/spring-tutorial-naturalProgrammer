...
<div class="panel panel-primary">
	...
	<div class="panel-body">
		...
		<form:form role="form" method="post"> <!-- without 'action', it will default to the same page, so action="/login" -->
			...
			<div class="form-group">
				<label for="pwssword">Password</label>
				<input type="password" id="password" name="password" class="form-control">
				<form:errors ccsClass="error" path="password" />
			</div>
